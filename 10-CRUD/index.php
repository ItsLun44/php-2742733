...
<body class="fondo_index">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" style="margin-bottom: 30px;">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./img/perro1.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/perro2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/perro3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <div class="container text-center fondo_perro_roto" style="margin-top: 30px;">
        <div class="row align-items-center">
            <div class="col">

                <h1>Cursos de cuidado de <br> razas de perros</h1>
            ...
            <div class="col" style="padding: 20px;">
                <img class="perro_roto" src="./img/perro_roto.jpg" alt="">
            </div>
        </div>
    </div>  
